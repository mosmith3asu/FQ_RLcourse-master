...
FQL_settings = {}
FQL_settings['num_episodes'] = 50       # number of repeated interactions
FQL_settings['max_epi_duration'] = 30   # terminal duration in seconds
...
def main():
    ...
    n_episodes = FQL_settings['num_episodes']
    n_warmup = 5
    n_perform = 5
